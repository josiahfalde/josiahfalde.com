        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_1fr] lg:gap-20">
          <div>
            ...
            <p className="mt-6">
              <a
                ...
                className="inline-flex items-center gap-2.5 font-medium text-copper-deep transition-colors hover:text-ink"
              >
          ...
          <div className="space-y-4 leading-relaxed text-ink-soft">
            <p>
              ...
              <Link to="/websites" className="font-medium text-copper-deep hover:text-ink">
                Websites
              </Link>{" "}
