...
const PLACES: Place[] = [
  ...
  },
  {
    ...
    lon: 0.5,
    lat: 43.0,
    note: "A sibling trip: Madrid, up to Santander, over the border to Biarritz, and plenty of stops in between, with a visit to missionary friends we love in Spain along the way.",
    photos: [],
  },
];
